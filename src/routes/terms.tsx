...
const sections = [
  ...
  { h: "6. Intellectual property", p: "EquinoxSphere Technologies retains all rights in the OFC360 service. You retain all rights to content you create." },
  ...
  { h: "11. Governing law", p: "These terms are governed by the laws of India, without regard to its conflict of law principles." },
  { h: "12. Contact", p: "Questions about these terms? Contact info@ofc360.com." },
];
