...
import { $ as deleteEmployee, E as activateEmployee, It as resendEmployeeInvite, Kt as updateEmployee, Lt as resetEmployeePassword, Z as deactivateEmployee, ot as fetchEmployees, q as createEmployee, ut as fetchOrgChart, zt as resolveDepartmentValue } from "./ofc360-store-DqGLmdH1.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/EmployeesPage-DsHqLR-R.js
...
function EmployeeFormDialog({ open, onOpenChange, draft, onDraftChange, submitting, onSave, allEmployees = [] }) {
	...
	const currentManagerValue = draft?.managerId || "none";
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								...
								onValueChange: (val) => {
									const selectedMgr = managerOptions.find((m) => m.id === val);
									onDraftChange({
										...draft,
										managerId: val === "none" ? void 0 : val,
										managerName: val === "none" ? void 0 : selectedMgr?.fullName
									});
								},
		...
		if (draft.id !== "") {
			const result = await dispatch(updateEmployee({
				...
				payload: {
					...
					shift: draft.shift,
					manager_id: draft.managerId || void 0
				}
			}));
