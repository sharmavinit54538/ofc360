...
import { Cn as FileCheck, Rn as Coins, Zn as CircleCheck, gr as CalendarDays, jn as Download, nt as Printer, ut as Percent, xr as Building2 } from "../_libs/lucide-react.mjs";
import { r as PageHeader } from "./DashboardShell-B-wJDcuP.mjs";
import { t as Button } from "./button-OuFjfcpS.mjs";
import { t as Badge } from "./badge-D1Dupn2y.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/EmployeePayslips-sQfMt4mt.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: SAMPLE_PAYSLIPS.map((slip, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						onClick: () => setSelectedIdx(i),
						className: `flex items-center gap-2 rounded-xl px-4 py-2 text-xs font-semibold transition-all cursor-pointer ${selectedIdx === i ? "bg-indigo-600 text-white shadow-md" : "border border-border bg-background/50 text-muted-foreground hover:text-foreground"}`,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: ["Salary Slip for the month of ", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: "NEW REGIME (FY 2026-27)"
							})] })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Rupees Sixty Five Thousand Only"
							})
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							onClick: handleDownloadPDF,
