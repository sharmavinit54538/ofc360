//#region node_modules/.nitro/vite/services/ssr/assets/blog-data-DcYz3eWl.js
var posts = [
	{
	...
	},
	{
		...
		content: ["Design systems are easy to start and brutal to scale. Once dozens of teams depend on your tokens and components, every change becomes a migration.", "We rebuilt our system from the ground up to support contribution at scale. Here's what we learned."]
	},
	{
		...
		content: ["The SaaS landscape is shifting. The all-in-one suites that dominated the last decade are being unbundled by composable, API-first tools.", "This isn't just a product trend — it's a structural change in how companies buy software."]
	},
	{
		...
		content: ["Remote engineering culture isn't built in all-hands meetings. It's built in the small rituals of daily work."]
	},
	{
		...
		content: ["Every product team is shipping AI features. Most of them won't be used a month after launch.", "The features that stick share three properties: they remove a real chore, they're invisible until needed, and they get out of the way the moment you have momentum."]
	},
	{
		...
		content: ["Most SaaS dashboards measure dozens of metrics. The teams that grow fastest watch five."]
	}
];
var categories = [
	"All",
...
//#endregion
export { posts as n, categories as t };
