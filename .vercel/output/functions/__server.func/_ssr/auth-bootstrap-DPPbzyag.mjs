...
import { At as ofc360, Tt as isAccessTokenExpired, Vt as setTokens, bt as hasValidAccessToken, vt as getTokens } from "./ofc360-store-DqGLmdH1.mjs";
import { t as api } from "./client-CZ8BuUX8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-bootstrap-DPPbzyag.js
...
function getPostLoginRoute(user) {
	...
	if (user.role?.toLowerCase() === "super_admin") return "/dashboard/super-admin";
