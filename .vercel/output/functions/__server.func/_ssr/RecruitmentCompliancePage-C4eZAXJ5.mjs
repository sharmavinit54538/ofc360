...
//#region node_modules/.nitro/vite/services/ssr/assets/RecruitmentCompliancePage-C4eZAXJ5.js
...
function RecruitmentCompliancePage() {
	...
	const [controls, setControls] = (0, import_react.useState)(defaultControls);
	const [checklist, setChecklist] = (0, import_react.useState)(defaultChecklist);
