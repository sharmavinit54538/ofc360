...
function Page() {
	...
	function ask(q) {
		...
		if (lower.includes("who owns ofc360") || lower.includes("who are the owners of ofc360") || lower.includes("who founded ofc360") || lower.includes("who is behind ofc360") || lower.includes("owner of ofc360") || lower.includes("owners of ofc360")) reply = "OFC360 is owned by Banoth Siddharth and Vinit Sharma.";
		setMsgs((m) => [
			...m,
			{
				role: "user",
