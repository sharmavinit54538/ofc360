...
import { nn as useofc360, t as BASE_URL } from "./ofc360-store-BR2yEBkC.mjs";
...
import { n as useRecruitment } from "./useRecruitment-DS-o2BRM.mjs";
...
import { n as getPublicJobApplicationUrl, t as getPublicAppUrl } from "./public-url-xo-yITRU.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/JobDetailPage-BHQMbqnV.js
...
function JobDetailPage() {
	...
	const [qrSvgMarkup, setQrSvgMarkup] = (0, import_react.useState)(null);
	...
	const handleGenerateQr = async () => {
		...
		try {
			...
			const [pngDataUrl, svgString] = await Promise.all([import_lib.toDataURL(applyUrl, {
				width: 512,
				margin: 2,
				errorCorrectionLevel: "H"
			}), import_lib.toString(applyUrl, {
				type: "svg",
				width: 512,
				margin: 2,
				errorCorrectionLevel: "H"
	...
	(0, import_react.useEffect)(() => {
		if (showQrModal) handleGenerateQr();
	}, [showQrModal]);
	(0, import_react.useEffect)(() => {
	...
	const handleCopySourcingLink = async () => {
		...
		try {
			...
			try {
				...
				const res = await api.get(`/jobs/${jobId}/sourcing-link?frontend_url=${encodeURIComponent(frontendUrl)}`);
							...
							children: [[
								{
									...
									url: getPublicJobApplicationUrl(jobId)
								},
								{
									label: "Internal Employee Referral Link",
									url: `${getPublicJobApplicationUrl(jobId)}?ref=employee`
								},
								{
									label: "Campus Sourcing URL",
									url: `${getPublicJobApplicationUrl(jobId)}?tag=campus`
								}
									...
									children: [
										...
										chanObj.url && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: getPublicJobApplicationUrl(chanObj.url)
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
														href: getPublicJobApplicationUrl(chanObj.url),
														target: "_blank",
														rel: "noreferrer",
														children: "Visit"
													})
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[10px] text-muted-foreground text-center break-all px-2",
							children: getPublicJobApplicationUrl(jobId)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
