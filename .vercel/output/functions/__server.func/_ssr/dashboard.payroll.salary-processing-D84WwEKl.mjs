...
import { $ as RefreshCw, B as ShieldCheck, Fn as CreditCard, Hn as Clock, K as Search, Mt as Lock, S as TrendingUp, Zn as CircleCheck, n as Zap, u as Users } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard.payroll.salary-processing-D84WwEKl.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: hero?.total_net_payroll != null ? `₹${hero.total_net_payroll.toLocaleString("en-IN", { minimumFractionDigits: 2 })}` : "—"
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "text-2xl font-bold tracking-tight text-foreground font-mono",
										children: [
											hero?.processed_employees ?? "—",
											" / ",
											hero?.active_employees_count ?? "—"
										]
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-2xl font-bold tracking-tight text-foreground font-mono",
										children: kpis?.accuracy_rate != null ? `${kpis.accuracy_rate}%` : "—"
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, { children: !workflow?.steps || workflow.steps.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "py-6 text-center text-xs text-muted-foreground",
					children: "No approval workflow steps available for this cycle."
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: filteredItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											...
											children: item.basic_salary != null ? `₹${item.basic_salary.toLocaleString("en-IN")}` : "—"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "py-3 px-4 text-right font-mono",
											children: item.gross_salary != null ? `₹${item.gross_salary.toLocaleString("en-IN")}` : "—"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "py-3 px-4 text-right font-mono text-rose-400",
											children: item.total_deductions != null ? `-₹${item.total_deductions.toLocaleString("en-IN")}` : "—"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "py-3 px-4 text-right font-mono font-bold text-emerald-400",
											children: item.net_salary != null ? `₹${item.net_salary.toLocaleString("en-IN")}` : "—"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											className: "py-3 px-4 text-center",
