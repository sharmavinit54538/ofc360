...
import { Et as promoteDepartmentEmployee, F as bulkSetDepartmentStatus, G as deleteDepartment, It as transferDepartmentEmployees, M as bulkAssignDepartmentManager, N as bulkDeleteDepartments, Ot as removeEmployeeFromDepartment, Q as fetchDepartments, Rt as updateDepartment, b as addEmployeeToDepartment, en as useMounted, nn as useofc360, pt as importDepartments, z as createDepartment } from "./ofc360-store-BR2yEBkC.mjs";
import { y as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { t as Input } from "./input-B8HDFcHP.mjs";
import { $ as RefreshCw, $n as CircleCheck, B as ShieldCheck, Cr as Building2, Hr as Activity, Ir as ArrowUpDown, K as Search, Kt as Landmark, Mn as DollarSign, Nr as Award, Nt as LoaderCircle, On as Ellipsis, Ot as MapPin, Rr as ArrowRightLeft, Sr as Building, T as Trash2, Tn as Eye, Un as Clock, Yn as CircleQuestionMark, _n as FileSpreadsheet, ar as ChevronLeft, at as Plus, dr as ChartNoAxesColumnIncreasing, er as CircleCheckBig, f as User, fr as ChartLine, ft as Pen, g as UserMinus, gn as FileText, hr as Calendar, ir as ChevronRight, jn as Download, ln as Funnel, lr as ChartPie, nr as CircleAlert, or as ChevronDown, pr as ChartColumn, qn as CircleX, t as lucide_react_exports, tr as CircleArrowUp, u as Users, v as UserCheck, wr as Briefcase, y as Upload, yt as Network } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/DepartmentsPage-CUtYachD.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, {
					...
					if (!d || !d.name || !d.name.trim() || !d.code || !d.code.trim() || !d.status) return null;
...
function DepartmentsPage() {
	const ws = useofc360();
	const { departments, loading, error, refetch, createDepartment, updateDepartment, deleteDepartment, bulkDelete, bulkSetStatus, bulkAssignManager, importDepartments, addEmployeeToDept, removeEmployeeFromDept, transferEmployees, promoteEmployee } = useDepartments();
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DepartmentStatsCards, { departments }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
												...
												}), STATUS_OPTIONS.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
													value: opt.value,
													children: opt.label
												}, opt.value))] })]
											})]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
												...
												}), OFFICES.map((off) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
													value: off,
													children: off
												}, off))] })]
											})]
								...
								loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl border border-border/60 bg-card/10 p-12 text-center flex flex-col items-center justify-center min-h-[300px]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-8 w-8 text-brand animate-spin mb-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-sm font-medium text-muted-foreground",
										children: "Loading departments data..."
									})]
								}) : error && departments.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl border border-dashed border-rose-500/40 bg-rose-500/5 p-12 text-center flex flex-col items-center justify-center min-h-[300px]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "mx-auto mb-4 grid h-14 w-14 place-items-center rounded-2xl bg-rose-500/10 text-rose-500 shadow-sm",
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-1 text-sm text-muted-foreground max-w-sm",
											children: departments.length === 0 ? "No departments found in the system. Create a department to get started." : "No corporate divisions match your search query. Try clearing filters."
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
