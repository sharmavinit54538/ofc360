...
import { Et as Minus, Wr as ArrowRight, mr as Check, z as Sparkles } from "../_libs/lucide-react.mjs";
...
import { t as FAQ } from "./FAQ-BsiZknSl.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pricing-J7-7Mcvi.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-hero-glow" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-center text-[10px] text-muted-foreground/50 uppercase tracking-widest mt-4",
						children: "All prices are placeholders — confirm pricing before publishing"
					}),
