...
import { Dn as ExternalLink, H as Share2, Tn as Eye, X as Save, _t as Palette, in as Globe } from "../_libs/lucide-react.mjs";
...
import { t as getPublicAppUrl } from "./public-url-CdfttniZ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CareerSitePage-DG2MTXUn.js
...
function CareerSitePage() {
	...
	const handleCopyUrl = () => {
		...
		const url = `${getPublicAppUrl()}/careers/${slug}`;
