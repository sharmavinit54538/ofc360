...
//#region node_modules/.nitro/vite/services/ssr/assets/ExecutiveDashboardPage-CxJ0uyXC.js
...
function Card({ children, className = "", noPad = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: `rounded-2xl border border-border bg-card/80 backdrop-blur-xl shadow-xs transition-all ${noPad ? "" : "p-5 sm:p-6"} ${className}`,
		children
	});
}
