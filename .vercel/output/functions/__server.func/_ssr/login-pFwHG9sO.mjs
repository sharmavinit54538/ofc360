...
import { Pt as rememberStore, gt as getErrorMessage } from "./ofc360-store-B622ilCf.mjs";
import { t as api } from "./client-Ccck4qzu.mjs";
import { y as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { t as Input } from "./input-B8HDFcHP.mjs";
import { n as getPostLoginRoute, r as persistAuthSession } from "./auth-bootstrap-C_zJOW7b.mjs";
...
import { t as AuthShell } from "./AuthShell-3FtzaxqH.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-pFwHG9sO.js
...
function normalizeUser(raw) {
	...
	return {
		...
		is_verified: user.is_verified !== void 0 ? Boolean(user.is_verified) : user.isVerified !== void 0 ? Boolean(user.isVerified) : user.email_verified !== void 0 ? Boolean(user.email_verified) : true,
		onboarding_completed: user.onboarding_completed !== void 0 ? Boolean(user.onboarding_completed) : user.onboardingCompleted !== void 0 ? Boolean(user.onboardingCompleted) : true,
...
function parseLoginResponse(res) {
	...
	if (!finalAccessToken || !user) return null;
	return {
