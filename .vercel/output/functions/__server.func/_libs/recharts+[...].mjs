...
import { C as require_isString, D as require_isFunction, E as require_memoize, O as require_isObject, S as require_isNumber, T as require_get, _ as require_throttle, a as require_every, b as require_upperFirst, c as require_isBoolean, d as require_maxBy, f as require_isEqual, g as require_last, h as require_max, i as require_find, l as require_isPlainObject, m as require_min, n as require_some, o as require_mapValues, p as require_flatMap, r as require_range, s as require_first, t as require_omit, u as require_minBy, v as require_sortBy, w as require_isNil, x as require_isNaN, y as require_uniqBy } from "./lodash.mjs";
...
var adaptEventsOfChild = function adaptEventsOfChild(props, data, index) {
	if (!(0, import_isObject.default)(props) || _typeof$48(props) !== "object") return null;
	var out = null;
...
var hasClipDot = function hasClipDot(dot) {
	return dot && _typeof$47(dot) === "object" && "clipDot" in dot;
};
/**
...
function Surface(props) {
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$35({}, filterProps(others, true, "svg"), {
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$40(_objectSpread$40({}, _objectWithoutProperties$19(_ref, _excluded$19)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (cx === +cx && cy === +cy && size === +size) return /*#__PURE__*/ import_react.createElement("path", _extends$34({}, filteredProps, {
	...
	return _createClass$23(DefaultLegendContent, [
		{
			...
			value: function renderIcon(data) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
					var iconProps = _objectSpread$39({}, data);
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					return /*#__PURE__*/ import_react.createElement("li", _extends$33({
						className,
						style: itemStyle,
	...
	return _createClass$22(Legend, [
		...
		},
		{
			...
			value: function getBBoxSnapshot() {
				if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) return _objectSpread$38({}, this.lastBoundingBox);
				return {
					width: 0,
					height: 0
				};
		...
		},
		{
			...
			value: function render() {
				...
				var outerStyle = _objectSpread$38(_objectSpread$38({
					position: "absolute",
					width: width || "auto",
					height: height || "auto"
				...
				}, renderContent$1(content, _objectSpread$38(_objectSpread$38({}, this.props), {}, { payload: getUniqPayload(payload, payloadUniqBy, defaultUniqBy$1) })));
			}
		}
	], [{
		key: "getWithHeight",
...
var DefaultTooltipContent = function DefaultTooltipContent(props) {
	...
	var renderContent = function renderContent() {
		if (payload && payload.length) {
			...
			var items = (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map(function(entry, i) {
				if (entry.type === "none") return null;
				var finalItemStyle = _objectSpread$37({
					display: "block",
					paddingTop: 4,
					paddingBottom: 4,
	...
	var finalStyle = _objectSpread$37({
		margin: 0,
		padding: 10,
		backgroundColor: "#fff",
	...
	return /*#__PURE__*/ import_react.createElement("div", _extends$32({
		className: wrapperCN,
		style: finalStyle
	...
	return _createClass$21(TooltipBoundingBox, [
		...
		},
		{
			...
			value: function render() {
				...
				var outerStyle = _objectSpread$36(_objectSpread$36({ transition: isAnimationActive && active ? "transform ".concat(animationDuration, "ms ").concat(animationEasing) : void 0 }, cssProperties), {}, {
					pointerEvents: "none",
	...
	return _createClass$20(Tooltip, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(TooltipBoundingBox, {
				...
				viewBox,
				wrapperStyle
			}, renderContent(content, _objectSpread$35(_objectSpread$35({}, this.props), {}, { payload: finalPayload })));
		}
	}]);
}(import_react.PureComponent);
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)(function(_ref, ref) {
	...
	var chartContent = (0, import_react.useMemo)(function() {
		...
		return import_react.Children.map(children, function(child) {
			if (/*#__PURE__*/ import_react.isValidElement(child)) return /*#__PURE__*/ (0, import_react.cloneElement)(child, _objectSpread$34({
				width: calculatedWidth,
				height: calculatedHeight
			}, isCharts ? { style: _objectSpread$34({
				height: "100%",
				width: "100%",
...
function removeInvalidKeys(obj) {
	var copyObj = _objectSpread$33({}, obj);
...
var getStringSize = function getStringSize(text) {
	...
	try {
		...
		var measurementSpanStyle = _objectSpread$33(_objectSpread$33({}, SPAN_STYLE), copyStyle);
...
var Text = function Text(_ref5) {
	...
	return /*#__PURE__*/ import_react.createElement("text", _extends$31({}, filterProps(textProps, true), {
		x,
		y,
...
function _toConsumableArray$8(arr) {
	return _arrayWithoutHoles$8(arr) || _iterableToArray$8(arr) || _unsupportedIterableToArray$14(arr) || _nonIterableSpread$8();
}
		...
		value: function render() {
			...
			var errorBars = data.map(function(entry) {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, _extends$29({
					...
					return /*#__PURE__*/ import_react.createElement("line", _extends$29({}, coordinates, { key: "line-".concat(coordinates.x1, "-").concat(coordinates.x2, "-").concat(coordinates.y1, "-").concat(coordinates.y2) }));
				}));
			});
...
var getLegendProps = function getLegendProps(_ref) {
	...
	var legendProps = legendDefaultProps !== void 0 ? _objectSpread$32(_objectSpread$32({}, legendDefaultProps), legendItem.props) : {};
	var legendData;
	if (legendItem.props && legendItem.props.payload) legendData = legendItem.props && legendItem.props.payload;
		...
		var itemProps = itemDefaultProps !== void 0 ? _objectSpread$32(_objectSpread$32({}, itemDefaultProps), item.props) : {};
	...
	return _objectSpread$32(_objectSpread$32(_objectSpread$32({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
		payload: legendData,
		item: legendItem
	});
};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem(item) {
	...
	var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread$31(_objectSpread$31({}, item.type.defaultProps), item.props) : item.props;
	...
	for (var i = 0, len = numericAxisIds.length; i < len; i++) {
		...
		for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
			...
			if (barItems && barItems.length) {
				...
				var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread$31(_objectSpread$31({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber$1(offset[align])) return _objectSpread$31(_objectSpread$31({}, offset), {}, _defineProperty$34({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber$1(offset[verticalAlign])) return _objectSpread$31(_objectSpread$31({}, offset), {}, _defineProperty$34({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		var _item$type2;
		var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread$31(_objectSpread$31({}, item.type.defaultProps), item.props) : item.props;
		...
		return _objectSpread$31(_objectSpread$31({}, result), {}, _defineProperty$34({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$31(_objectSpread$31({}, res), {}, _defineProperty$34({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$31(_objectSpread$31({}, result), {}, _defineProperty$34({}, axisId, group));
	}, {});
};
/**
...
var getStackedDataOfItem = function getStackedDataOfItem(item, stackGroups) {
	var _item$type3;
	var stackId = ((_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread$31(_objectSpread$31({}, item.type.defaultProps), item.props) : item.props).stackId;
	if (isNumOrStr(stackId)) {
...
var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
	var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread$31(_objectSpread$31({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
	...
	return _objectSpread$31(_objectSpread$31({}, filterProps(graphicalItem, false)), {}, {
		dataKey,
		unit,
		formatter,
		name: name || dataKey,
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		var ticks = getTicksOfScale(scale, _objectSpread$30(_objectSpread$30({}, axis), {}, { realScaleType }));
		var finalAxis = _objectSpread$30(_objectSpread$30(_objectSpread$30({}, axis), ticks), {}, {
			range,
			radius: outerRadius,
			realScaleType,
			scale,
		...
		return _objectSpread$30(_objectSpread$30({}, result), {}, _defineProperty$33({}, id, finalAxis));
	}, {});
};
...
var inRangeOfSector = function inRangeOfSector(_ref5, sector) {
	...
	if (inRange) return _objectSpread$30(_objectSpread$30({}, sector), {}, {
		radius,
...
var renderRadialLabel = function renderRadialLabel(labelProps, label, attrs) {
	...
	return /*#__PURE__*/ import_react.createElement("text", _extends$28({}, attrs, {
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel(props) {
	...
	if (position === "top") return _objectSpread$29(_objectSpread$29({}, {
		x: x + width / 2,
	...
	if (position === "bottom") return _objectSpread$29(_objectSpread$29({}, {
		x: x + width / 2,
	...
	if (position === "left") {
		...
		return _objectSpread$29(_objectSpread$29({}, _attrs2), parentViewBox ? {
	...
	if (position === "right") {
		...
		return _objectSpread$29(_objectSpread$29({}, _attrs3), parentViewBox ? {
	...
	if (position === "insideLeft") return _objectSpread$29({
		x: x + horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$29({
		x: x + width - horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$29({
		x: x + width / 2,
		y: y + verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$29({
		x: x + width / 2,
		y: y + height - verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$29({
		x: x + horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$29({
		x: x + width - horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$29({
		x: x + horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$29({
		x: x + width - horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if ((0, import_isObject.default)(position) && (isNumber$1(position.x) || isPercent(position.x)) && (isNumber$1(position.y) || isPercent(position.y))) return _objectSpread$29({
		x: x + getPercentValue(position.x, width),
		y: y + getPercentValue(position.y, height),
		textAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$29({
		x: x + width / 2,
		y: y + height / 2,
		textAnchor: "middle",
		verticalAnchor: "middle"
...
function Label(_ref4) {
	...
	var props = _objectSpread$29({ offset }, restProps);
	...
	return /*#__PURE__*/ import_react.createElement(Text, _extends$28({ className: clsx("recharts-label", className) }, attrs, positionAttrs, { breakAll: textBreakAll }), label);
}
...
var parseLabel = function parseLabel(label, viewBox) {
	...
	if ((0, import_isObject.default)(label)) return /*#__PURE__*/ import_react.createElement(Label, _extends$28({ viewBox }, label, { key: "label-implicit" }));
	return null;
};
...
function LabelList(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map(function(entry, index) {
		...
		return /*#__PURE__*/ import_react.createElement(Label, _extends$27({}, filterProps(entry, true), others, idProps, {
			parentViewBox: entry.parentViewBox,
			value,
			textBreakAll,
			viewBox: Label.parseViewBox((0, import_isNil.default)(clockWise) ? entry : _objectSpread$28(_objectSpread$28({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
function parseLabelList(label, data) {
	...
	if ((0, import_isObject.default)(label)) return /*#__PURE__*/ import_react.createElement(LabelList, _extends$27({ data }, label, { key: "labelList-implicit" }));
	return null;
}
...
var PolarAngles = function PolarAngles(props) {
	...
	var polarAnglesProps = _objectSpread$27({ stroke: "#ccc" }, filterProps(props, false));
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map(function(entry) {
		...
		return /*#__PURE__*/ import_react.createElement("line", _extends$26({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle(props) {
	...
	var concentricCircleProps = _objectSpread$27(_objectSpread$27({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
	return /*#__PURE__*/ import_react.createElement("circle", _extends$26({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon(props) {
	...
	var concentricPolygonProps = _objectSpread$27(_objectSpread$27({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
	return /*#__PURE__*/ import_react.createElement("path", _extends$26({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, polarRadius.map(function(entry, i) {
		var key = i;
		if (gridType === "circle") return /*#__PURE__*/ import_react.createElement(ConcentricCircle, _extends$26({ key }, props, {
			radius: entry,
			index: i
		}));
		return /*#__PURE__*/ import_react.createElement(ConcentricPolygon, _extends$26({ key }, props, {
			radius: entry,
			index: i
		}));
	}));
...
var PolarGrid = function PolarGrid(_ref) {
	var _ref$cx = _ref.cx, cx = _ref$cx === void 0 ? 0 : _ref$cx, _ref$cy = _ref.cy, cy = _ref$cy === void 0 ? 0 : _ref$cy, _ref$innerRadius = _ref.innerRadius, innerRadius = _ref$innerRadius === void 0 ? 0 : _ref$innerRadius, _ref$outerRadius = _ref.outerRadius, outerRadius = _ref$outerRadius === void 0 ? 0 : _ref$outerRadius, _ref$gridType = _ref.gridType, gridType = _ref$gridType === void 0 ? "polygon" : _ref$gridType, _ref$radialLines = _ref.radialLines, radialLines = _ref$radialLines === void 0 ? true : _ref$radialLines, props = _objectWithoutProperties$12(_ref, _excluded$12);
	if (outerRadius <= 0) return null;
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid" }, /*#__PURE__*/ import_react.createElement(PolarAngles, _extends$26({
		cx,
		cy,
		innerRadius,
		outerRadius,
		gridType,
		radialLines
	}, props)), /*#__PURE__*/ import_react.createElement(ConcentricPath, _extends$26({
		cx,
		cy,
		innerRadius,
		outerRadius,
	...
	return _createClass$17(PolarRadiusAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties$11(_this$props3, _excluded$11);
				var extent = ticks.reduce(function(result, entry) {
					return [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)];
				}, [Infinity, -Infinity]);
				var point0 = polarToCartesian(cx, cy, extent[0], angle);
				var point1 = polarToCartesian(cx, cy, extent[1], angle);
				var props = _objectSpread$26(_objectSpread$26(_objectSpread$26({}, filterProps(others, false)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
					x1: point0.x,
					y1: point0.y,
					x2: point1.x,
					y2: point1.y
				});
				return /*#__PURE__*/ import_react.createElement("line", _extends$25({ className: "recharts-polar-radius-axis-line" }, props));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks() {
				var _this = this;
				var _this$props4 = this.props, ticks = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$11(_this$props4, _excluded2$5);
				var textAnchor = this.getTickTextAnchor();
				var axisProps = filterProps(others, false);
				var customTickProps = filterProps(tick, false);
				var items = ticks.map(function(entry, i) {
					var coord = _this.getTickValueCoord(entry);
					var tickProps = _objectSpread$26(_objectSpread$26(_objectSpread$26(_objectSpread$26({
						textAnchor,
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$25({}, props, { className: "recharts-polar-radius-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$29(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$29(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$29(PolarRadiusAxis, "defaultProps", {
	type: "number",
	radiusAxisId: 0,
	cx: 0,
	cy: 0,
...
var Dot = function Dot(props) {
	...
	if (cx === +cx && cy === +cy && r === +r) return /*#__PURE__*/ import_react.createElement("circle", _extends$24({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var Polygon = function Polygon(props) {
	...
	if (baseLinePoints && baseLinePoints.length) {
		...
		return /*#__PURE__*/ import_react.createElement("g", { className: layerClass }, /*#__PURE__*/ import_react.createElement("path", _extends$23({}, filterProps(others, true), {
			fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
			stroke: "none",
			d: rangePath
		})), hasStroke ? /*#__PURE__*/ import_react.createElement("path", _extends$23({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(points, connectNulls)
		})) : null, hasStroke ? /*#__PURE__*/ import_react.createElement("path", _extends$23({}, filterProps(others, true), {
			fill: "none",
			d: getSinglePolygonPath(baseLinePoints, connectNulls)
		})) : null);
	}
	var singlePath = getSinglePolygonPath(points, connectNulls);
	return /*#__PURE__*/ import_react.createElement("path", _extends$23({}, filterProps(others, true), {
	...
	return _createClass$16(PolarAngleAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$25(_objectSpread$25({}, filterProps(this.props, false)), {}, { fill: "none" }, filterProps(axisLine, false));
				if (axisLineType === "circle") return /*#__PURE__*/ import_react.createElement(Dot, _extends$22({ className: "recharts-polar-angle-axis-line" }, props, {
					cx,
					cy,
					r: radius
				}));
				...
				return /*#__PURE__*/ import_react.createElement(Polygon, _extends$22({ className: "recharts-polar-angle-axis-line" }, props, { points }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks() {
				...
				var customTickProps = filterProps(tick, false);
				var tickLineProps = _objectSpread$25(_objectSpread$25({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
				var items = ticks.map(function(entry, i) {
					var lineCoord = _this.getTickLineCoord(entry);
					var tickProps = _objectSpread$25(_objectSpread$25(_objectSpread$25({ textAnchor: _this.getTickTextAnchor(entry) }, axisProps), {}, {
						stroke: "none",
						fill: stroke
					}, customTickProps), {}, {
						index: i,
					...
					return /*#__PURE__*/ import_react.createElement(Layer, _extends$22({
						...
						key: "tick-".concat(entry.coordinate)
					}, adaptEventsOfChild(_this.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$22({ className: "recharts-polar-angle-axis-tick-line" }, tickLineProps, lineCoord)), tick && PolarAngleAxis.renderTickItem(tick, tickProps, tickFormatter ? tickFormatter(entry.value, i) : entry.value));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$22({}, props, { className: "recharts-polar-angle-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$28(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$28(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$28(PolarAngleAxis, "defaultProps", {
	type: "category",
	angleAxisId: 0,
	scale: "auto",
	cx: 0,
	...
	return _createClass$10(Line, [
		...
		},
		{
			...
			value: function renderCurveStatically(points, needClip, clipPathId, props) {
				...
				_this$props3.ref;
				var curveProps = _objectSpread$11(_objectSpread$11(_objectSpread$11({}, filterProps(_objectWithoutProperties$3(_this$props3, _excluded$3), true)), {}, {
					fill: "none",
...
var XAxis = /*#__PURE__*/ function(_React$Component) {
	function XAxis() {
		_classCallCheck$8(this, XAxis);
		return _callSuper$7(this, XAxis, arguments);
	}
	_inherits$7(XAxis, _React$Component);
	return _createClass$8(XAxis, [{
		key: "render",
		value: function render() {
...
var YAxis = /*#__PURE__*/ function(_React$Component) {
	function YAxis() {
		_classCallCheck$7(this, YAxis);
		return _callSuper$6(this, YAxis, arguments);
	}
	_inherits$6(YAxis, _React$Component);
	return _createClass$7(YAxis, [{
		key: "render",
		value: function render() {
...
function ReferenceLineImpl(props) {
	...
	var _endPoints = _slicedToArray$2(endPoints, 2), _endPoints$ = _endPoints[0], x1 = _endPoints$.x, y1 = _endPoints$.y, _endPoints$2 = _endPoints[1], x2 = _endPoints$2.x, y2 = _endPoints$2.y;
		...
		function CategoricalChartWrapper(_props) {
			...
			*/
			_defineProperty$2(_this, "renderLegend", function() {
				...
				var item = props.item;
				return /*#__PURE__*/ (0, import_react.cloneElement)(item, _objectSpread$2(_objectSpread$2({}, _objectWithoutProperties(props, _excluded)), {}, {
					chartWidth: width,
					chartHeight: height,
					margin,
...
//#endregion
export { Legend as C, Tooltip as S, PolarRadiusAxis as _, PieChart as a, Cell as b, YAxis as c, Line as d, CartesianGrid as f, PolarAngleAxis as g, Pie as h, RadarChart as i, XAxis as l, Radar as m, Funnel as n, BarChart as o, Bar as p, AreaChart as r, LineChart as s, FunnelChart as t, Area as u, PolarGrid as v, ResponsiveContainer as x, LabelList as y };
